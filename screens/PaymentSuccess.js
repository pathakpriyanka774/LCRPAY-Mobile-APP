...
export default function PaymentSuccess() {
  ...
  const { amount, phoneNumber, transactionType, transactionId } = route.params || {};

  useEffect(() => {
    // Track successful transaction
    trackActivity(ACTIVITY_TYPES.RECHARGE, {
      phone_number: phoneNumber || '9220648066',
      amount: amount || 10,
      transaction_type: transactionType || 'mobile_recharge',
      transaction_id: transactionId,
      status: 'success'
    });
  }, [amount, phoneNumber, transactionType, transactionId]);
        ...
        <View style={styles.card}>
          <View style={styles.rechargeRow}>
            ...
            <View style={{ marginLeft: 12 }}>
              <Text style={styles.phoneText}>{phoneNumber || '9220648066'}</Text>
              <Text style={styles.labelText}>Mobile Recharge</Text>
            </View>
          </View>

          <View style={styles.amountRow}>
            <Text style={styles.amountText}>₹{amount || 10}</Text>
            <Text style={styles.splitText}>Split Expense</Text>
          </View>

          <Text style={styles.noteText}>
            <Text style={styles.noteHighlight}>Note:</Text> Plan benefits have been applied to {phoneNumber || '9220648066'}.
          </Text>
